...
- movement labelled Geographical Data Science (GDS). This recent concept essentially combines ‘data science’ with GIS.
- focus on reproducibility and a command-line interface
